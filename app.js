...
function gameOver() {
    ...
    document.querySelector('.movesCount').innerHTML = 'moves: ' + (moves - 1);
//Top score when 3 stars still remain.  Player loose one star for every 2 miss matches
}
//shuffle
...
for (var i = 0; i < restart.length; i++) {
    restart[i].addEventListener('click', reloadPage);
